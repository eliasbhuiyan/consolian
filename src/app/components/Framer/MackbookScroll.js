  ...
  return (
    ...
    >
      <div className="absolute top-5 md:top-20 flex w-full flex-1 scale-y-50 md:scale-y-125 scale-x-50 md:scale-x-100 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-20 md:h-48 w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-20 md:h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        ...
        ></motion.div>
        <div className="absolute inset-auto z-40 h-20 md:h-44 w-full -translate-y-[12.5rem] bg-slate-950 "></div>
        <motion.h2
      ...
      />
      {/* Base area */}
      <div className="h-44 md:h-[22rem] w-full max-w-72 md:max-w-[32rem] bg-gray-200 rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
